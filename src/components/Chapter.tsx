...
export const Chapter = ({
  ...
  const getChapterTotalCount = (chapt: IChapterConf): number =>
      ...
      >
        <StyledAccordionSummary>
          <StyledAccordionTitleContainer>
            {chapter?.color && (
              <StyledAccordionTitleColorIndicator color={chapter.color} />
            )}
        ...
        <StyledAccordionActions>{actions}</StyledAccordionActions>
